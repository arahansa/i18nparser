package com.arahansa.view.test;
...
public class FindAndReplaceDemo extends JFrame implements ActionListener {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      boolean found = searchResult.wasFound();
      System.out.println("현재 범위? :"+textArea.getText());
      System.out.println("매치 래인지? ::"+searchResult.getMatchRange().getStartOffset()+","+searchResult.getMatchRange().getEndOffset());

      String beforeString = textArea.getText().substring(searchResult.getMatchRange().getStartOffset());

      String nextString = textArea.getText().substring(searchResult.getMatchRange().getEndOffset());
